...
const FeedPage = () => {
  ...
  const CONTROL_API_URL = "https://e8ce-2409-40c4-43-820a-5394-304d-cafb-c0df.ngrok-free.app/"
  ...
  useEffect(() => {
    ...
    const liveSocket = new WebSocket("wss://e8ce-2409-40c4-43-820a-5394-304d-cafb-c0df.ngrok-free.app/share")as any;
