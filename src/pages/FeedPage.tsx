...
const FeedPage = () => {
  ...
  const CONTROL_API_URL = "https://undeputized-quinton-monistically.ngrok-free.app/"
  ...
  useEffect(() => {
    ...
    const liveSocket = new WebSocket("wss://undeputized-quinton-monistically.ngrok-free.app/share")as any;
